...
### Regression Tree 
In this session, we look at Regression tree, a simple method that doesn't require any assumption on the distribution of the variables. It gives a simple method to choose the variables.
```{r}
