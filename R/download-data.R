...
country_indicators_url <- "https://drive.google.com/uc?id=1-2DR6B3EQXpaiUd5MEtod6UMg4DWImTs&export=download"
country_indicators_saved_file <- "data/country_indicators.csv"
download.file(country_indicators_url, destfile = country_indicators_saved_file)